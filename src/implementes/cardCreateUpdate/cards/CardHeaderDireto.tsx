...
interface CardHeaderProps {
  SetDados: solictacao.SolicitacaoDiretotypes;
}

export async function CardHeaderDireto({ SetDados }: CardHeaderProps) {
    ...
    <>
      <Box display="flex" alignItems="center" justifyContent="space-between">
        ...
        <Box alignItems="center" textAlign={{ base: "center", md: "left" }}>
          ...
          {input !== "USER" && (
            <Text fontSize={{ base: "sm", md: "md" }}>
              Finaceiro: {SetDados.financeiro && SetDados.financeiro?.nome}
            </Text>
          )}
        </Box>
      </Box>
